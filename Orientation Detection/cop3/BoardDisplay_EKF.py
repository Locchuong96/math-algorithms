...
class ProjectionViewer:
	...
	def run(self,sensorInstance):
		...
		while running:
			...
			angularVelocity = sensorInstance.getSerialData()[:3] # get the gyro from sensor
			self.wireframe.quatRotate(angularVelocity, 1/loopRate) # dt = 1/loopRate
			self.display()
...
if __name__ == "__main__":
	...
	portName = 'COM5'
	baudRate = 115200
	dataNumBytes = 4 # the number of bytes for each data point
	numParams = 9 
